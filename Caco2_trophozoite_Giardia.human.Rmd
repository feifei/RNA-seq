...
human_trophozoite_logFC_mat <- logFC_mat
human_trophozoite_DT_mat <- DT_mat
save(human_trophozoite_logFC_mat, human_trophozoite_DT_mat, file="data/human.trophozoite.logFC.rda")
```
