---
title: "edgeR for DE analysis of Lauras Caco-2 cells interacting with encysting Giardia cells, Giardia part"
author: "Feifei Xu"
date: "`r Sys.Date()`"
output: 
  html_document:
...
# Background
This report provides the analysis of RNA-Seq data from Caco-2 cells interacting with encystating *Giardia* cells, only the *Giardia* part.  Caco2 cell (human) analysis is done in a separate file.
...
d <- d[-c(1,10), ] # Remove 171120B1 and 171121D1 which are Human controls
